...
def build_readme(cases: list[ExampleCase], script_rel_path: str) -> str:
    ...
    lines.append("")
    lines.append("Each transform is shown side-by-side:")
    lines.append("- left: input")
    lines.append("- right: expected output")
    ...
    for case in cases:
        ...
        lines.append("<table>")
        lines.append("<tr><th>From</th><th>To</th></tr>")
        lines.append("<tr>")
        lines.append(f"<td><pre><code class=\"language-python\">{escape(left_src)}</code></pre></td>")
        lines.append(f"<td><pre><code class=\"language-python\">{escape(right_src)}</code></pre></td>")
        lines.append("</tr>")
        lines.append("</table>")
        lines.append("")
